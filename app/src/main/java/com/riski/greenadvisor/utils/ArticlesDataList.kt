...
object ArticlesDataList {
    private val data = arrayOf(
        arrayOf(
            "Hal Penting yang Perlu Diperhatikan Saat Menyiram Tanaman",
            "Tanaman",
            "Air adalah salah satu kebutuhan dasar yang diperlukan oleh semua makhluk hidup. Manusia, hewan dan " +
            "tumbuhan tidak akan bertahan hidup tanpa air. Bahkan, ada mahluk hidup yang harus hidup di dalam air semisal aneka ikan dan biota air lainnya." +
            ...
            "Salah satu faktor penting dalam merawat tanaman adalah memperhatikan agar  keperluan air  terpenuhi. Tidak berlebihan, pun tak berkekurangan.Praktik yang biasa dilakukan agar tanaman tidak kekurangan air adalah melakukan penyiraman. " +
            "Terlihat sepele, namun sering kali kita melakukan kesalahan saat menyiram tanaman." +
            ...
            "2. Menyiramkan air pada akar,\n" +
            "3. Menggunakan air berkualitas,\n" +
            "4. Memakai jumlah air yang tepat,\n" +
            "5. Memakai alat siram yang cocok.",
            "12 Mei 2023",
            R.raw.articles1,
            "Kompasiana.com"),
        arrayOf(
            ...
            "Kompasiana.com"),
        arrayOf(
            "Bayam Brazil untuk Perkotaan",
            "Tanaman",
            "Temen-temen pasti sudah tidak asing dengan sayur bayam bukan? Tanaman hijau satu ini memang menjadi salah satu sayuran yang banyak diminati oleh masyarakat Indonesia karena kelezatannya. \n" +
            "\n" +
            ...
            "\n" +
            "Bunganya signifikan, kecil dan berwarna putih, cocok untuk daerah tropis dan sub tropis. Tinggi tanaman bayam brazil bisa mencapai 50 cm. Bayam brazil memiliki daun yang berwarna hijau muda hingga hijau tua bundar dan berkerut. \n" +
            "\n" +
            "Perbedaan warna pada daun bayam brazil dipengaruhi oleh intensitas cahaya matahari. Tapi jangan khawatir, tanaman yang satu ini juga bisa hidup dan beradaptasi pada full-sun maupun partial-sun. \n" +
            "Bagi temen-temen yang tertarik dan ingin membudidaya tanaman ini, tanaman ini sangat mudah dalam penanaman dan perawatan hingga masa panen. Tanaman ini dapat beradaptasi dan hidup di tanah dengan pH rendah maupun tinggi, loh. \n" +
            "\n" +
        ...
        arrayOf(
            ...
            "Kompasiana.com"),
        arrayOf(
            "Menyulap Rumah Menjadi Taman Saur dan Buah",
            "Tanaman",
    ...
    fun getArticles(): List<ArticlesData> {
        return data.map { article ->
            ArticlesData(article[0] as String, article[1] as String, article[2] as String,
                article[3] as String, article[4] as Int, article[5] as String)
        }
    }
}